...
// each of which fails loudly if forgotten: the name in the Recording type's union
...
export type Category = Recording["category"]
...
// Keyed by the Recording type's Category union, so the compiler rejects both a name
// that is not a Category and a Category with no row.
export const CATEGORIES: Record<Category, CategoryRow> = {
  Accordions: {
    legacySlug: "accordions",
    assetSlug: "accordions",
    file: "accordions",
    exportName: "accordions",
  },
  "Arc Sliders": {
    legacySlug: "arcsliders",
    assetSlug: "arcsliders",
    file: "arcsliders",
    exportName: "arcsliders",
  },
  "Bottom Sheets": {
  ...
  Carousels: {
    legacySlug: "carousels",
    assetSlug: "carousels",
    file: "carousels",
    exportName: "carousels",
  },
  Charts: {
    legacySlug: "charts",
    assetSlug: "charts",
  ...
  "Drop Down": {
    legacySlug: "dropdowns",
    assetSlug: "dropdowns",
    file: "dropdowns",
    exportName: "drop_down",
  },
  "Full Apps": {
    legacySlug: "fullapps",
    assetSlug: "fullapps",
    file: "fullapps",
    exportName: "full_apps",
  },
  Headers: {
    legacySlug: "headers",
    assetSlug: "headers",
  ...
  Misc: {
    legacySlug: "miscellaneous",
    assetSlug: "misc",
    file: "misc",
    exportName: "misc",
  },
  Onboarding: {
    legacySlug: "onboardings",
    assetSlug: "onboardings",
    file: "onboardings",
    exportName: "onboarding",
  },
  Parallaxes: {
    legacySlug: "parallaxes",
    assetSlug: "parallaxes",
    file: "parallaxes",
    exportName: "parallaxes",
  },
  Pickers: {
    legacySlug: "pickers",
    assetSlug: "pickers",
...
export const LEGACY_REDIRECTS: Record<string, string | undefined> =
  Object.fromEntries(
    CATEGORY_NAMES.map((name) => [
      `/${CATEGORIES[name].legacySlug}`,
